...
function escribirTexto() {
  ...
  mostrar(
    ...
    'saludo.textContent = "' +
      ...
      'se ven tal cual, como texto. Es la opción segura, pero menos flexible.'
  );
}
...
function mostrarNodeName() {
  mostrar(
    ...
    'Propiedades heredadas de Node:\n\n' +
      '  nodeName: ' +
      inputPrueba.nodeName +
      '   (nombre de la etiqueta, en mayúsculas)\n' +
      '  nodeType: ' +
      inputPrueba.nodeType +
      '          (1 = elemento)\n' +
      '  tagName:  ' +
      inputPrueba.tagName +
      '    (esta viene de Element)'
  );
}
...
// for (const nodo of contenedor.childNodes) {
//   if (nodo.nodeType === Node.ELEMENT_NODE) {
//     console.log(nodo.tagName, nodo);
//   }
// }
